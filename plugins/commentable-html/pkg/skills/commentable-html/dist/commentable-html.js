  ...
  box.innerHTML =
    ...
    '<div class="cm-help-body">' +
      T('The review workflow',
        ...
        '</ol>' +
        '<p><strong>Just want to leave a comment?</strong> If someone shared this file with you to review, you do not need an agent or an account: select any text, click <em>Add Comment</em>, then hand your notes back with <strong>Copy all</strong> or <strong>Export as Portable</strong>. See <em>Getting started</em> next.</p>', true) +
      T('Getting started (or reviewing a shared file)',
        '<p>This page is a <strong>commentable</strong> document. If a colleague sent it to you to review, everything you need is in the file itself - no install, no agent, no account.</p>' +
        '<ul>' +
          ...
          '<li>Hand your review back with <strong>Copy all</strong> (paste it to an agent) or <strong>Export as Portable</strong> (one file to send to a person, with your comments baked in).</li>' +
