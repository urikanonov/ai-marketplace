...
#
# Fast path: if the version marker exists, exit immediately (no Python spawn). Otherwise find a
...
if (Test-Path (Join-Path $skill ".skill-resources-$Version.ok")) { exit 0 }
$py = $null
