...
| CMH-TOC-12 | help | opt-out: the deck has no in-document Contents list - the fold is a flow-document reading affordance for a long report, and a slide has nothing to fold |
