...
| CMH-MENU-ICON-04 | help | opt-out: a one-click route to the project page from the chrome of any document, present on every deck slide already; a slide about the toolbar's own brand link would teach a viewer nothing the mark itself does not |
