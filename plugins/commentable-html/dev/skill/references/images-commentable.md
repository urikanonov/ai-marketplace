...
4. The ring is restored across reload, and the comment round-trips through **Copy all** (`Anchor: image #N` or `Anchor: chart #N` plus alt/label data) and **Export as Shareable** like text, mermaid, and diff comments.
