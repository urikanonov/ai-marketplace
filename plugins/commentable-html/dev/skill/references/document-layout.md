...
export actions, **Manage storage**, **Clear all comments**, and Help. The sidebar header pins a meta row (document-type bubble, layer version, and the
...
Plain HTML, Markdown, PDF), and a **More** menu holding **Manage storage** and **Clear all comments**.
...
**Clear all comments** keeps a danger color and opens a confirm dialog whose default action is **Cancel**. Enter, Escape,
