...
| `88-threads.css` | CMH-AUTHOR, CMH-THREAD, CMH-RICH | Author pill, sidebar identity control, the thread root-entry / reply layout + Reply button, and the compact side-pane variant of the formatting toolbar. |
