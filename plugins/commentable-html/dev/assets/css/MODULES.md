...
| `20-chrome.css` | CMH-SIDE, CMH-HELP, CMH-FOOT, CMH-DENSITY, CMH-RICH, CMH-GROW | Attribution footer, sidebar meta, help dialog, TOC chrome, the in-document comment dialog (including its compact formatting toolbar), and the composer / dialog textarea sizing bounds the autogrow layer grows within. |
