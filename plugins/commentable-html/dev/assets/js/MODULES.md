...
| `46-comment-selection.js` | CMH-PICK | Per-comment selection: the transient, self-pruning pick set of thread roots, the panel's selection bar, and the confirmed `Clear selected comments` delete. |
