    ...
    '<div class="cm-help-body">' +
      ...
      T('Navigation',
        '<ul>' +
          ...
          '<li>In a flow document, an in-document <strong>Contents</strong> list has its own caret: fold it away to reclaim the top of a long report, or click the folded title to bring it back. This browser remembers your choice for this document. (A deck has no in-document Contents list, so it has no caret either.)</li>' +
