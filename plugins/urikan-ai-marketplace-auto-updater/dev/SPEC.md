...
| UPD-08 | A last-run throttle skips the whole update pass when the previous pass ran less than the configured cadence (default ~20 hours) ago (logged), and a completed pass refreshes the stamp. | `updater.Tests.ps1` -> "UPD-08 last-run throttle" |
